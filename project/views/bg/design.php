...
<html>
    <head>
        ...
        <link rel="stylesheet/less" type="text/css" href="<?= SITE_PATH; ?>css/style_new.less" />

        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
        <script type="text/javascript" src="<?= SITE_PATH; ?>js/less-1.4.1.min.js"></script>
        <script type="text/javascript" src="<?= SITE_PATH; ?>js/app.js"></script>
    </head>
    <body>
        <div id="container">
            <header>
                ...
                <nav>
                    <a href="<?= SITE_PATH; ?>">Home</a>  <a href="<?= SITE_PATH; ?>tickets/active">Active tickets</a>  <a href="<?= SITE_PATH; ?>tickets/closed">Closed tickets</a>
                </nav>
                <div class="clear"></div>
            </header>
            <div id="page">
